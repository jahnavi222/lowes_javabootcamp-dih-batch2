...
public class EmployeeValidator implements Validator {
	...
	public boolean supports(Class<?> arg0) {
		return Employee1.class.isAssignableFrom(arg0);
	}
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "doj", "doj.required", "Field date of join is required.");
		
		Employee1 employee = (Employee1) target;
		if(employee.getAge() != null && employee.getAge() < 0 && employee.getAge() >18)
		{
