...
public class Employee {
    ...
    public String toString() {
        ...
        return (this.getName()+FIELD_DELIM+this.getAge()+FIELD_DELIM
    ...
    public Employee(String name, int age, String department, String designation, String country, LocalDate doj, LocalDateTime nowTime, LocalDateTime nowTime2) {
    	this.name = name;
        this.age = age;
        this.department = department;
        this.designation = designation;
